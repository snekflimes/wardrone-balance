...
export const SUPPORT_CARD_BATTLE_COLUMN_HINT = `Симулятор и прогноз читают заголовки колонок (без учёта регистра): количество / число — численность; здоровье / ХП — HP одного союзника; суммарное (или всего) здоровье / ХП — общий пул HP; бонус HP цели — пассив карты №17 (max HP базы); урон — урон за попадание (для расчёта DPS вместе со скорострельностью); бонус урона (%) — ЭМИ; длительность — время эффекта; лечение / ХП/сек — ремонтный дрон; отражение (%) — поле; мана; перезарядка; скорость; дальность; скорострельность; радиус. Колонки «Карточек/Монет до уровня» в бою не используются.`;
