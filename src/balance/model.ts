...
export interface EconomyConfig {
  ...
  combatSkill?: {
    ...
    /**
     * Доля теоретического урона стволов, которая реально снимает HP с разнесённых целей:
     * переключение, прострел «в пустоту», неполное попадание по клумпу, оверкилл по мелочи. 0–100.
     * Умножается на множитель промахов/слабых попаданий. Не задано — 100 (без доп. штрафа).
     */
    spreadSpatialEfficiencyPercent?: number;
    /**
