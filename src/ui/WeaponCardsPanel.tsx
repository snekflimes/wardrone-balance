...
export const WeaponCardsPanel: React.FC<{
  ...
  return (
    <section>
      <h3>Оружие</h3>
      <p className="ui-hint">
        У каждого оружия свои базовые параметры и коэффициенты. У пулемёта рост урона/боезапаса привязан к референсу{' '}
        <strong>War Drone 3D</strong> (25-mm пушка: на ур. 27 в игре урон 36, боеприпасы 108). Гидра/Хеллфайр — общий блок{' '}
        <code style={{ color: '#cbd5e1' }}>weapons.growth</code>. В шапке карточки — <strong>база софта</strong> и{' '}
        <strong>множитель стоимости</strong> апгрейда.
      </p>
